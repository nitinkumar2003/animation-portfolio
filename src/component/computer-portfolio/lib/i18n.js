...
const translations = {
  en: {
    file: "File", view: "View", go: "Go", window: "Window", help: "Help", system: "System", connect: "Connect", search: "Spotlight", available: "AVAILABLE", featured: "FEATURED BUILD", openProject: "Open project", systemCapacity: "SYSTEM CAPACITY", projects: "projects", years: "years", layers: "layers",
  ...
  hi: {
    file: "फाइल", view: "देखें", go: "जाएं", window: "विंडो", help: "सहायता", system: "सिस्टम", connect: "संपर्क", search: "स्पॉटलाइट", available: "काम के लिए उपलब्ध", featured: "प्रमुख प्रोजेक्ट", openProject: "प्रोजेक्ट खोलें", systemCapacity: "सिस्टम क्षमता", projects: "प्रोजेक्ट", years: "वर्ष", layers: "लेयर",
  ...
  ar: {
    file: "ملف", view: "عرض", go: "انتقال", window: "نافذة", help: "مساعدة", system: "النظام", connect: "تواصل", search: "Spotlight", available: "متاح للعمل", featured: "مشروع مميز", openProject: "افتح المشروع", systemCapacity: "قدرة النظام", projects: "مشاريع", years: "سنوات", layers: "طبقات",
...
const interfaceTranslations = {
  en: {
    open: "Open", quickLook: "Quick Look", save: "Save", cancel: "Cancel", personalize: "Personalize this workstation.", autoSave: "Preferences save automatically.",
  ...
  hi: {
    open: "खोलें", quickLook: "क्विक लुक", save: "सेव करें", cancel: "रद्द करें", personalize: "इस वर्कस्टेशन को अपने अनुसार बनाएं।", autoSave: "सेटिंग्स अपने आप सेव होती हैं।",
  ...
  ar: {
    open: "فتح", quickLook: "نظرة سريعة", save: "حفظ", cancel: "إلغاء", personalize: "خصص محطة العمل حسب تفضيلاتك.", autoSave: "يتم حفظ التفضيلات تلقائياً.",
