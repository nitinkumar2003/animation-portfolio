      ...
      return (
        ...
        >
          <POPUP className="img-content relative">
            <div className="h-[280px] w-[350px] hover:scale-125 transition duration-500 cursor-pointer shadow-xl rounded-md overflow-hidden sm:h-[250px] sm:w-[92%] sm:bg-cover mx-auto ">
              <img
                src={data.img}
                alt={data.title}
